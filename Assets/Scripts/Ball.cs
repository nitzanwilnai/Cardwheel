...
public class Ball : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        Debug.Log(gameObject.name + " collided with " + col.gameObject.name + " c " + c + " i " + i + " collisionScale " + collisionScale + " col.relativeVelocity.magnitude " + col.relativeVelocity.magnitude);
